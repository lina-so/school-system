                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-3" title="طالب" href="{{route('login_show','student')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/img/student.png')}}">
                                </a>
                                <a class="btn btn-default col-lg-3" title="ولي امر" href="{{route('login_show','parent')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/img/parent.png')}}">
                                </a>
                                <a class="btn btn-default col-lg-3" title="معلم" href="{{route('login_show','teacher')}}">
