...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">classrooms</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ classrooms list</span>
						</div>
					</div>
...
@section('content')
				...
				@if(session()->has('update_classroom'))
				<script>
				window.onload=function(){
				notif({
				...
				<div class="row">
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<a class="modal-effect btn btn-outline-primary btn-md" data-effect="effect-scale"  data-toggle="modal" href="#modaldemo8"> Add classroom</a>
							...
							<div class="card-body">
											...
											<tr>
												...
												<td>
															...
															<a class="modal-effect btn btn-sm btn-warning " data-effect="effect-scale"
														     href="#modaldemo9{{$classroom->id}}"  data-toggle="modal"  title="تعديل"><i
								...
								<!-- edit -->
                                        ...
                                        <div class="modal" id="modaldemo9{{$classroom->id}}">
															...
															<form action="{{route('classroom.update','test')}}" method="post">
																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control" id="id" name="id" value="{{$classroom->id}}" >

																	<div class="form-group">
																		<label for="exampleInputEmaili"> classroom Name_ar</label>
																
																		<input type="text" class="form-control" id="class_name" name="class_name"  value="{{$classroom->getTranslation('class_name','ar')}}" required>
																	</div>

																	<div class="form-group">
																		<label for="exampleInputEmaili"> classroom Name_en</label>
																
																		<input type="text" class="form-control" id="class_name_en" name="class_name_en"  value="{{$classroom->getTranslation('class_name','en')}}" required>
																	</div>
