...
<div class="modal fade" id="graduation{{$promotion->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('students.destroy','test')}}" method="post">
                    @csrf
                    @method('DELETE')
                    <input type="text" name="id" value="{{$promotion->student_id}}">
                    <input type="text" name="page_id" value="2">
